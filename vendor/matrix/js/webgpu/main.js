...
export default async (canvas, config) => {
	...
	// MATRIX-VIZ: removed the window-level double-click-to-fullscreen-the-canvas (see regl/main.js +
	// MODIFICATIONS.md). Fullscreen is owned by the app (app/fullscreen.js). This WebGPU path is unused
	// in the prototype; kept in sync with the regl twin so a grep for the old behavior stays clean.
